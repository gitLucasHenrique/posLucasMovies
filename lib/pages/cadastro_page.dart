...
import 'package:flutter_app/domain/response.dart';


import 'package:flutter_app/utils/nav.dart';class CadastroPage extends StatefulWidget {
  @override
  _CadastroPageState createState() => _CadastroPageState();
}

class _CadastroPageState extends State<CadastroPage> {
  final _tNome = TextEditingController(text: "Ricardo Lecheta");
  final _tEmail = TextEditingController(text: "rlecheta@gmail.com");
